...
- **660 tests passing** — AQI, inversion, PBL, wind vectors, dispersion, fire, coupling,
...
`pytest backend/tests -q` (660 at 1.16.0; 635 when this phase landed). No backend/DB/API-shape changes — this phase is frontend/docs only.
