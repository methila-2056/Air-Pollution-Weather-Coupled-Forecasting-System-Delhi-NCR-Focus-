...
- **635 tests passing** — AQI, inversion, PBL, wind vectors, dispersion, fire, coupling,
...
`pytest backend/tests -q` (635). No backend/DB/API-shape changes — this phase is frontend/docs only.