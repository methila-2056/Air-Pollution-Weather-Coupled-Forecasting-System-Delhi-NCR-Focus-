...
[![Tests](https://img.shields.io/badge/tests-541%20passed-green)](backend/tests)
...
```bash
python -m pytest backend/tests -q            # 541 unit + integration tests
...
- **CI** — `.github/workflows/ci.yml`:
  1. *Backend:* ruff + full pytest suite (`541 passed`).
